...
wget -O panel.sh "https://raw.githubusercontent.com/leopkks/owpanel/main/$SERVER_OS/panel.sh"
wget -O requirements.txt "https://raw.githubusercontent.com/leopkks/owpanel/main/requirements.txt"
